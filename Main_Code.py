...
class Train_Ticket():
    ...
    def Admin_SignUp(self):
        ...
        Train_Ticket.Admin_list.append(User(name, add,mo_no,email,newkey))
    ...
    def Cust_SignUp(self):
        ...
        Train_Ticket.Cust_list.append(User(name, add,mo_no,email,newkey))
    ...
    def Tc_SignUp(self):
        ...
        Train_Ticket.Tc_list.append(User(name, add,mo_no,email,newkey))
    ...
    def ticket_book(self,usr):
        ...
        Train_Ticket.ticket_list.append(TICKET_BOOK(Class, bdg_pt, quota, str(usr)))
